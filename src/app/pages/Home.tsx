      ...
      <section id="planes" className="py-4 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-2">
            ...
            {/* Plan Premium */}
            <div className="bg-gradient-to-br from-purple-600 via-pink-600 to-red-600 p-2.5 rounded-lg shadow-2xl hover:scale-105 transition-all duration-300 text-white relative border-4 border-yellow-300 pt-8">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-yellow-300 via-orange-400 to-red-500 text-white px-4 py-1 rounded-full font-black text-sm shadow-2xl whitespace-nowrap">
