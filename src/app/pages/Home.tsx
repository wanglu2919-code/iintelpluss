      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-600 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-32 md:py-40 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            ...
            {/* Subheadline */}
            <p className="text-lg md:text-2xl text-blue-100 dark:text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed font-light">
      ...
      <section className="py-24 bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 dark:from-blue-900 dark:via-purple-900 dark:to-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-4">Números que Hablan por Sí Solos</h2>
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-2xl p-8 text-center hover:bg-white/15 transition-all transform hover:scale-105">
              <div className="text-5xl md:text-6xl font-black text-yellow-300 mb-3">50K+</div>
              <p className="text-white text-lg font-semibold">Clientes Satisfechos</p>
            </div>

            <div className="bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-2xl p-8 text-center hover:bg-white/15 transition-all transform hover:scale-105">
              <div className="text-5xl md:text-6xl font-black text-green-300 mb-3">6+</div>
              <p className="text-white text-lg font-semibold">Años de Experiencia</p>
            </div>

            <div className="bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-2xl p-8 text-center hover:bg-white/15 transition-all transform hover:scale-105">
              <div className="text-5xl md:text-6xl font-black text-pink-300 mb-3">98%</div>
              <p className="text-white text-lg font-semibold">Satisfacción del Cliente</p>
            </div>

            <div className="bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-2xl p-8 text-center hover:bg-white/15 transition-all transform hover:scale-105">
              <div className="text-5xl md:text-6xl font-black text-orange-300 mb-3">24/7</div>
      ...
      <section id="planes" className="py-24 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Plan Básico */}
            <div className="bg-gradient-to-br from-cyan-500 to-blue-600 p-8 rounded-xl shadow-xl hover:scale-105 transition-all duration-300 text-white relative border-2 border-cyan-300">
              ...
              <h3 className="text-3xl font-bold mb-2 mt-2">Plan Básico</h3>
              <div className="mb-4">
            ...
            <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 p-8 rounded-xl shadow-2xl hover:scale-110 transition-all duration-300 text-white relative border-4 border-yellow-400 transform scale-105">
              ...
              <h3 className="text-3xl font-bold mb-2 mt-4">Plan Premium</h3>
            ...
            {/* Plan Ultra */}
            <div className="bg-gradient-to-br from-orange-500 to-red-600 p-8 rounded-xl shadow-xl hover:scale-105 transition-all duration-300 text-white relative border-2 border-orange-300">
              ...
              <h3 className="text-3xl font-bold mb-2 mt-2">Plan Ultra</h3>
              <div className="mb-4">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500 text-gray-800 dark:text-white px-6 py-4 rounded-lg font-bold transition"
                    >
                      Cancelar
                    </button>
                    <button
                      ...
                      className={`flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-4 rounded-lg font-bold transition-all shadow-lg transform hover:scale-105 flex items-center justify-center gap-2 ${
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`flex-1 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white px-6 py-4 rounded-lg font-bold transition-all shadow-lg transform hover:scale-105 flex items-center justify-center gap-2 ${
