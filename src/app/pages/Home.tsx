...
export function Home() {
  ...
  return (
    <>
              ...
              {isProcessing ? (
                ...
                <div className="text-center py-8">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-3 rounded-xl text-lg font-bold transition-all shadow-lg transform hover:scale-105"
                  >
                    Entendido
                  </button>
                </div>
                ...
                <div className="text-center">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-6 py-3 rounded-xl text-lg font-bold transition-all shadow-lg transform hover:scale-105"
                  >
                    Agendar Ahora
                  </button>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-4xl md:text-4xl font-black text-gray-900 dark:text-white mb-4">¿Quiénes Somos?</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center mb-10">
              ...
              <div className="bg-gradient-to-br from-blue-500 to-blue-700 dark:from-blue-600 dark:to-blue-900 p-8 rounded-3xl shadow-2xl">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-800/50 border border-gray-200 dark:border-gray-700 py-10 px-10 rounded-3xl shadow-xl">
              <div className="text-center mb-8">
      ...
      <section className="py-14 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <h2 className="text-4xl md:text-4xl font-black text-gray-900 dark:text-white mb-4">Lo Que Dicen Nuestros Clientes</h2>
            <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-700 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-gray-800 dark:to-gray-700 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
              <div className="flex gap-1 mb-4">
                {[1,2,3,4,5].map((star) => (
                  <Star key={star} className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                ))}
            ...
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-gray-800 dark:to-gray-700 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all transform hover:scale-105">
              <div className="flex gap-1 mb-4">
                {[1,2,3,4,5].map((star) => (
                  <Star key={star} className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                ))}
      ...
      <section id="metodos-pago" className="py-12 bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            {/* Header */}
            <div className="text-center mb-8">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 mb-8 border-4 border-green-300">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl shadow-2xl p-6 mb-8 text-white">
              <div className="text-center mb-8">
            ...
            {/* CTA Section */}
            <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-2xl shadow-2xl p-6 md:p-8 text-white text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white text-green-600 hover:bg-green-50 px-6 py-3 rounded-xl font-bold text-lg transition-all shadow-lg inline-flex items-center justify-center gap-3 transform hover:scale-105"
                >
                  <MessageCircle className="w-6 h-6" />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl font-bold text-lg transition-all shadow-lg inline-flex items-center justify-center gap-3 transform hover:scale-105"
                >
                  <MessageCircle className="w-6 h-6" />
      ...
      {/* FAQ Section */}
      <section className="py-14 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-4xl md:text-4xl font-black text-gray-900 dark:text-white mb-4">Preguntas Frecuentes</h2>
      ...
      {/* Contact Section */}
      <section id="contacto" className="py-10 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4">
