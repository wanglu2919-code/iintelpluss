...
import logoImg from "../../imports/intel-plus-logo.png";
          ...
          <div className="flex items-center justify-between h-9">
            ...
            <nav className="hidden lg:flex items-center gap-0.5">
              ...
              <a
                ...
                className="ml-1 flex items-center gap-1 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white px-2.5 py-0.5 rounded-full text-xs font-bold transition-all shadow-sm hover:shadow-md"
              >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="border-t border-gray-700 pt-6">
              <p className="text-gray-400 text-sm text-center">
                © 2026 Intel Plus. Todos los derechos reservados.
              </p>
            </div>
          </div>
        </div>
